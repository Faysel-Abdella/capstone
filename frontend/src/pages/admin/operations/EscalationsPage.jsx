  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-semibold text-slate-900">Operational Escalations</h2>
        <p className="mt-2 text-sm text-slate-500">
          Escalations capture exceptions to normal queue flow. They are logged for audit and tracked to
          resolution.
        </p>
      </div>
