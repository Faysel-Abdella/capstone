  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-semibold text-slate-900">Reputation & Quality Control</h2>
        <p className="mt-2 text-sm text-slate-500">
          Only completed queue transactions generate ratings. Trust signals combine ratings, punctuality,
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-3 text-3xl font-semibold text-slate-900">{data.averageRating}</p>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Trust Score</p>
          <p className="mt-3 text-3xl font-semibold text-slate-900">{data.trustScore}%</p>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Fraud Prevention</p>
