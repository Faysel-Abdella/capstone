  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-semibold text-slate-900">System Integrations (Demo)</h2>
        <p className="mt-2 text-sm text-slate-500">
          External integrations enable payments, messaging, and analytics partnerships. All connectors are
          demo-only in this capstone build.
        </p>
      </div>
